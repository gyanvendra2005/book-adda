...
export default function page() {
  ...
  return (
    <>
     {/* Header Section */}
     <div className="mt-20 text-center bg-yellow-400 w-full h-10 flex items-center justify-center">
      ...
      <div className="mt-20 px-8 md:px-16">
        <div className="flex justify-between items-center">
          ...
          {/* Right Section for Image or Feature */}
          <div className="hidden md:block">
            <img
              src="/_next/static/media/banner.32957c88.jpeg"
              alt="Book Store"
              className="w-94 h-94 object-cover rounded-lg"
            />
          </div>
        </div>
      </div>
      ...
      <div className="mt-20 px-8 md:px-16">
        <p className="text-2xl font-semibold text-center">Sponsered Books</p>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-10">
          <div className="bg-white p-4 rounded-lg shadow-lg">
            ...
            <div className="mt-4 text-center">
              <p className="text-xl font-semibold text-gray-800">Book Title 1</p>
              <p className="text-gray-500">Author Name</p>
              <p className="text-lg font-bold text-gray-700 mt-2">$19.99</p>
          ...
          <div className="bg-white p-4 rounded-lg shadow-lg">
            ...
            />
            <div className="mt-4 text-center">
              <p className="text-xl font-semibold text-gray-800">Book Title 2</p>
              <p className="text-gray-500">Author Name</p>
              <p className="text-lg font-bold text-gray-700 mt-2">$15.99</p>
              <button className="mt-4 w-full bg-orange-500 text-white py-2 rounded-lg">
                Add to Cart
              </button>
            </div>
          ...
          <div className="bg-white p-4 rounded-lg shadow-lg">
            ...
            />
            <div className="mt-4 text-center">
              <p className="text-xl font-semibold text-gray-800">Book Title 3</p>
              <p className="text-gray-500">Author Name</p>
              <p className="text-lg font-bold text-gray-700 mt-2">$25.99</p>
              <button className="mt-4 w-full bg-orange-500 text-white py-2 rounded-lg">
                Add to Cart
              </button>
            </div>
       ...
       <div className="mt-20 bg-gray-100 py-16">
         <div className="container mx-auto px-8">
          <p className="text-3xl font-semibold text-center text-gray-800">Why We're Better</p>
          <div className="flex flex-col md:flex-row justify-between mt-12">
            {/* Left Side - Book Categories and Filters */}
            <div className="w-full md:w-1/2 space-y-8">
              <p className="text-xl font-semibold text-gray-800">Advanced Filtering Options</p>
            ...
            {/* Right Side - Second Hand Book Condition */}
            <div className="w-full md:w-1/2 space-y-8">
              <p className="text-xl font-semibold text-gray-800">Second-Hand Book Condition</p>
              <p className="text-gray-600">
