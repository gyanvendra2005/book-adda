...
export default function BookSellingPage() {
  ...
  return (
    ...
    <div className="w-full lg:w-2/5 h-2/3 mt-24 bg-gradient-to-br from-orange-500 to-red-800 dark:from-zinc-900 dark:to-zinc-900 text-white rounded-md font-medium shadow-lg p-10 m-4">
      <h2 className="text-4xl font-bold mb-8">Ready to Sell?</h2>
      <p className="text-lg mb-4">
        Provide the book details. Share a good description and pictures to make it appealing to buyers.
      </p>
      <h3 className="text-2xl font-semibold mb-4">Info About Condition</h3>
